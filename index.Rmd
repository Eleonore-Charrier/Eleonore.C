...
* New_Data_Arrange: You will need to change the **last function variable** with the Classification name in the taxomic order of choice as seen in the **"Sunburst table" tab** of the walkthrough. 

```{}
  New_Data_Arrange <- Function_Arrange(New_Data, New_Data$Taxonomy_Value ,c(TO CHANGE)
```
